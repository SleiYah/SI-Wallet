...
function addNewWallet() {
    ...
    axios.post('http://localhost/projects/SI-Wallet/Wallet-Server/wallets/v1/add-update-wallet.php', walletData, {
        headers: {
            'Authorization': `Bearer ${authToken}`
        }
    })
...
function deleteWallet() {
    ...
    axios.post(
        'http://localhost/projects/SI-Wallet/Wallet-Server/wallets/v1/delete-wallet.php',
